...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2026 at 10:48 PM
...
(16, 1, '5800157', '5800157100000016', 'saad', 'saad@gmail.com', '', 'xyzroad,kharadar,karachi', '0987654321', 300, 'Delivered', '2026-07-06 20:03:35', 1),
...
(18, 3, '3000129', '3000129300000018', 'saad', 'saad@gmail.com', '', 'xyzroad,kharadar,karachi', '0987654321', 500, 'To Pay', '2026-07-06 20:08:21', 1);
...
(15, '3000129300000018', '1', '3000129', 'Wapsi', 1);
...
(129, '30', '00129', '3000129', 'Wapsi', 'can you give all of these decor items a two word  name set their price in pkr and give a 100 description on each of them which doesnt include inverted comas backslash semicolon and apostrophe', 788, 500, 9, 'n1.jpg'),
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `cleanup_unpaid_orders` ON SCHEDULE EVERY 5 MINUTE STARTS '2026-07-07 00:17:18' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    DELETE FROM `orders`
    WHERE `status` = 'To Pay'
      AND (trim(`Card_no`) = '' OR `Card_no` IS NULL)
